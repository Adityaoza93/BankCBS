...
public class Withdraw extends JFrame {
	...
	public Withdraw() {
		...
		setTitle("Withdraw - FinVerse PSB");
		setType(Type.POPUP);
		...
		JLabel lblNewLabel_8 = new JLabel("Debit Amount");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					try {
						...
						email.setContent("<h1>Amount of Rs "+debit_amount+" successfully withdrawn from account "+textField_6.getText()+". Available Balance: Rs "+textField_7.getText()+"</h1>", "text/html");
